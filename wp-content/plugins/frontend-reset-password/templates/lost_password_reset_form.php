	...
	<form id="resetpasswordform" method="post" class="account-page-form som-pass-strength-form">
		<fieldset>
			...
			<p>
				...
				<label for="som_new_user_pass"><?php _e( '新しいパスワード', 'frontend-reset-password' ); ?></label>
			...
			<p>
				...
				<label for="som_new_user_pass_again"><?php _e( 'パスワード再入力', 'frontend-reset-password' ); ?></label>
